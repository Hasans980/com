...
//        int[] gambar = new int[6];
        ...
        if (Integer.parseInt(angka) == 6) {
            Toast.makeText(MainActivity.this,"Angka Maximal",Toast.LENGTH_LONG).show();
...
//            gambar[5] = R.drawable.dice_6;
    ...
    private void toast() {
        ...
        Toast.makeText(MainActivity.this,"tombol di tekan",Toast.LENGTH_LONG).show();
